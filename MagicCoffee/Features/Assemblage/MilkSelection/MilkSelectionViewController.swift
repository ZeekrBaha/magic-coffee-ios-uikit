...
final class MilkSelectionViewController: UIViewController {

    // MARK: - Properties

    private let viewModel: MilkSelectionViewModel
    var onDismiss: (() -> Void)?
    ...
    init(viewModel: MilkSelectionViewModel) {
    ...
    private func setupUI() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "MilkCell")
...
extension MilkSelectionViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MilkCell", for: indexPath)

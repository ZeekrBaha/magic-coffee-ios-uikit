...
final class OngoingOrdersViewController: UIViewController {

    // MARK: - Properties

    private let viewModel: OngoingOrdersViewModel
    ...
    private let tableView: UITableView = {
        ...
        tv.accessibilityIdentifier = "ongoing_orders_table"
        return tv
    }()

    private let emptyLabel: UILabel = {
        let label = UILabel()
        label.text = "No ongoing orders"
    ...
    init(viewModel: OngoingOrdersViewModel) {
...
extension OngoingOrdersViewController: UITableViewDataSource {
